...
typedef enum { _DUMMY_1 } ESocketProtocol, EConnectAttemptResult, EChannelMode, EPeerStatID;
...
WIREFOX_API size_t          wirefox_peer_get_stat(HWirefoxPeer* handle, TPeerID who, EPeerStatID stat);
